 ...
 */
let addListener = (eventName, target, fn) => target.addEventListener(eventName, fn);
/*
 Задание 2:
 ...
 */
let removeListener = (eventName, target, fn) => target.removeEventListener(eventName, fn);
/*
 Задание 3:
 ...
 */
let skipDefault = (eventName, target) => target.addEventListener(eventName, e => e.preventDefault());
/*
 Задание 4:
 ...
 */
let delegate = (target, fn) => target.addEventListener('click', e => {if (e.target.tagName === 'BUTTON') fn()})
/*
 Задание 6:
